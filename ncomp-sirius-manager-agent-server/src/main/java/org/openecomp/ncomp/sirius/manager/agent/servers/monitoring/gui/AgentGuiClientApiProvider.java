...
public class AgentGuiClientApiProvider extends BasicGuiClientApiProvider {
	private static final Logger logger = Logger.getLogger(AgentGuiClientApiProvider.class);
	GuiClientApi o;

	public AgentGuiClientApiProvider(ISiriusServer controller, GuiClientApi o) {
		super(controller, o);
		this.o = o;
	}
