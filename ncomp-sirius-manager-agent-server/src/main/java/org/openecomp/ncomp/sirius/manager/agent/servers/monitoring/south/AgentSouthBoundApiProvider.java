...
public class AgentSouthBoundApiProvider extends BasicAdaptorProvider {
	private static final Logger logger = Logger.getLogger(AgentSouthBoundApiProvider.class);
	SouthBoundApi o;

	public AgentSouthBoundApiProvider(ISiriusServer controller, SouthBoundApi o) {
		super(controller, o);
		this.o = o;
	}
