...
public class AgentGuiClientApiConsole extends Console {
	public static final Logger logger = Logger.getLogger(AgentGuiClientApiConsole.class);
    protected AgentGuiClientApiClient controller;
    



    public AgentGuiClientApiConsole(String filename, String name) {
            super(filename, name);
            controller = new AgentGuiClientApiClient(filename,name);
