...
public class AgentGuiClientApiClient extends GuiClientApiImpl {
	public static final Logger logger = Logger.getLogger(AgentGuiClientApiClient.class);
	static final EcompLogger ecomplogger = EcompLogger.getEcompLogger();
	public AbstractClient client;

	public AgentGuiClientApiClient(String file, String name) {
	...
	public AgentGuiClientApiClient(String file, String name1, String name2) {
	...
	public AgentGuiClientApiClient(AbstractClient c) {
		client = c;
