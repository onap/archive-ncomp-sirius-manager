...
public class AgentGuiClientApiProviderTemplate extends BasicGuiClientApiProvider {
	private static final Logger logger = Logger.getLogger(AgentGuiClientApiProviderTemplate.class);
	GuiClientApi o;

	public AgentGuiClientApiProviderTemplate(ISiriusServer controller, GuiClientApi o) {
		super(controller, o);
		this.o = o;
	}
