...
public class AgentModelFactory extends ModelFactoryImpl {
	public static final Logger logger = Logger.getLogger(AgentModelFactory.class);
	ISiriusServer server = null;
	@Override
	public EPackage getEPackage() { return ModelPackage.eINSTANCE; }
	public AgentModelFactory(ISiriusServer server) {
		this.server = server;
	}
	@Override
	public GuiClientApi createGuiClientApi() {
		return new AgentGuiClientApi(server);
	}
