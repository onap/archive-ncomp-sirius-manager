...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Kvm Disk</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdKvmDiskImpl#getAlerts <em>Alerts</em>}</li>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdKvmDiskImpl#getAlertingTemplate <em>Alerting Template</em>}</li>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdKvmDiskImpl#getDisk_octets_read <em>Disk octets read</em>}</li>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdKvmDiskImpl#getDisk_octets_write <em>Disk octets write</em>}</li>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdKvmDiskImpl#getDisk_ops_read <em>Disk ops read</em>}</li>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdKvmDiskImpl#getDisk_ops_write <em>Disk ops write</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CollectdKvmDiskImpl extends NamedEntityImpl implements CollectdKvmDisk {
	/**
	...
	protected EClass eStaticClass() {
		return CollectdPackage.Literals.COLLECTD_KVM_DISK;
	}
	...
	public EList<Alert> getAlerts() {
		if (alerts == null) {
			alerts = new EObjectContainmentEList<Alert>(Alert.class, this, CollectdPackage.COLLECTD_KVM_DISK__ALERTS);
		}
		return alerts;
	}
		...
		if (alertingTemplate != null && alertingTemplate.eIsProxy()) {
			...
			if (alertingTemplate != oldAlertingTemplate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CollectdPackage.COLLECTD_KVM_DISK__ALERTING_TEMPLATE, oldAlertingTemplate, alertingTemplate));
			}
		}
	...
	public void setAlertingTemplate(AlertingTemplate newAlertingTemplate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectdPackage.COLLECTD_KVM_DISK__ALERTING_TEMPLATE, oldAlertingTemplate, alertingTemplate));
	}
	...
	public void setDisk_octets_read(IncreasingULongMetricAttribute newDisk_octets_read) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectdPackage.COLLECTD_KVM_DISK__DISK_OCTETS_READ, oldDisk_octets_read, disk_octets_read));
	}
	...
	public void setDisk_octets_write(IncreasingULongMetricAttribute newDisk_octets_write) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectdPackage.COLLECTD_KVM_DISK__DISK_OCTETS_WRITE, oldDisk_octets_write, disk_octets_write));
	}
	...
	public void setDisk_ops_read(IncreasingULongMetricAttribute newDisk_ops_read) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectdPackage.COLLECTD_KVM_DISK__DISK_OPS_READ, oldDisk_ops_read, disk_ops_read));
	}
	...
	public void setDisk_ops_write(IncreasingULongMetricAttribute newDisk_ops_write) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectdPackage.COLLECTD_KVM_DISK__DISK_OPS_WRITE, oldDisk_ops_write, disk_ops_write));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CollectdPackage.COLLECTD_KVM_DISK__ALERTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CollectdPackage.COLLECTD_KVM_DISK__ALERTS:
				return getAlerts();
			case CollectdPackage.COLLECTD_KVM_DISK__ALERTING_TEMPLATE:
				if (resolve) return getAlertingTemplate();
				return basicGetAlertingTemplate();
			case CollectdPackage.COLLECTD_KVM_DISK__DISK_OCTETS_READ:
				return getDisk_octets_read();
			case CollectdPackage.COLLECTD_KVM_DISK__DISK_OCTETS_WRITE:
				return getDisk_octets_write();
			case CollectdPackage.COLLECTD_KVM_DISK__DISK_OPS_READ:
				return getDisk_ops_read();
			case CollectdPackage.COLLECTD_KVM_DISK__DISK_OPS_WRITE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AlertContainer.class) {
			switch (derivedFeatureID) {
				case CollectdPackage.COLLECTD_KVM_DISK__ALERTS: return AlertsPackage.ALERT_CONTAINER__ALERTS;
				case CollectdPackage.COLLECTD_KVM_DISK__ALERTING_TEMPLATE: return AlertsPackage.ALERT_CONTAINER__ALERTING_TEMPLATE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AlertContainer.class) {
			switch (baseFeatureID) {
				case AlertsPackage.ALERT_CONTAINER__ALERTS: return CollectdPackage.COLLECTD_KVM_DISK__ALERTS;
				case AlertsPackage.ALERT_CONTAINER__ALERTING_TEMPLATE: return CollectdPackage.COLLECTD_KVM_DISK__ALERTING_TEMPLATE;
				default: return -1;
			}
		}
