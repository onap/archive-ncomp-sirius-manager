...
/**
 */
package org.openecomp.ncomp.sirius.manager.agent.monitoring.util;
...
public class MonitoringSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MonitoringPackage.SIRIUS_MANAGER_AGENT_SERVER: {
				SiriusManagerAgentServer siriusManagerAgentServer = (SiriusManagerAgentServer)theEObject;
				T result = caseSiriusManagerAgentServer(siriusManagerAgentServer);
				if (result == null) result = caseAbstractManagementServer(siriusManagerAgentServer);
				if (result == null) result = caseSouthBoundApiWithProxy(siriusManagerAgentServer);
				if (result == null) result = caseSouthBoundApi(siriusManagerAgentServer);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sirius Manager Agent Server</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sirius Manager Agent Server</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSiriusManagerAgentServer(SiriusManagerAgentServer object) {
		return null;
	}
