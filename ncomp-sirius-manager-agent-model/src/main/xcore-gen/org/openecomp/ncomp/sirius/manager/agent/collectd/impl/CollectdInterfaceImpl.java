 ...
 * </p>
 * <ul>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdInterfaceImpl#getAlerts <em>Alerts</em>}</li>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdInterfaceImpl#getAlertingTemplate <em>Alerting Template</em>}</li>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdInterfaceImpl#getIf_errors_rx <em>If errors rx</em>}</li>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdInterfaceImpl#getIf_errors_tx <em>If errors tx</em>}</li>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdInterfaceImpl#getIf_octets_rx <em>If octets rx</em>}</li>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdInterfaceImpl#getIf_octets_tx <em>If octets tx</em>}</li>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdInterfaceImpl#getIf_packets_rx <em>If packets rx</em>}</li>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.agent.collectd.impl.CollectdInterfaceImpl#getIf_packets_tx <em>If packets tx</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectdInterfaceImpl extends NamedEntityImpl implements CollectdInterface {
	/**
	 ...
	 * @generated
	 */
	protected CollectdInterfaceImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CollectdPackage.Literals.COLLECTD_INTERFACE;
	}
	...
	public EList<Alert> getAlerts() {
		if (alerts == null) {
			alerts = new EObjectContainmentEList<Alert>(Alert.class, this, CollectdPackage.COLLECTD_INTERFACE__ALERTS);
		}
		return alerts;
	}
		...
		if (alertingTemplate != null && alertingTemplate.eIsProxy()) {
			...
			if (alertingTemplate != oldAlertingTemplate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CollectdPackage.COLLECTD_INTERFACE__ALERTING_TEMPLATE, oldAlertingTemplate, alertingTemplate));
			}
		}
	...
	public void setAlertingTemplate(AlertingTemplate newAlertingTemplate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectdPackage.COLLECTD_INTERFACE__ALERTING_TEMPLATE, oldAlertingTemplate, alertingTemplate));
	}
	...
	public void setIf_errors_rx(IncreasingULongMetricAttribute newIf_errors_rx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectdPackage.COLLECTD_INTERFACE__IF_ERRORS_RX, oldIf_errors_rx, if_errors_rx));
	}
	...
	public void setIf_errors_tx(IncreasingULongMetricAttribute newIf_errors_tx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectdPackage.COLLECTD_INTERFACE__IF_ERRORS_TX, oldIf_errors_tx, if_errors_tx));
	}
	...
	public void setIf_octets_rx(IncreasingULongMetricAttribute newIf_octets_rx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectdPackage.COLLECTD_INTERFACE__IF_OCTETS_RX, oldIf_octets_rx, if_octets_rx));
	}
	...
	public void setIf_octets_tx(IncreasingULongMetricAttribute newIf_octets_tx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectdPackage.COLLECTD_INTERFACE__IF_OCTETS_TX, oldIf_octets_tx, if_octets_tx));
	}
	...
	public void setIf_packets_rx(IncreasingULongMetricAttribute newIf_packets_rx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectdPackage.COLLECTD_INTERFACE__IF_PACKETS_RX, oldIf_packets_rx, if_packets_rx));
	}
	...
	public void setIf_packets_tx(IncreasingULongMetricAttribute newIf_packets_tx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollectdPackage.COLLECTD_INTERFACE__IF_PACKETS_TX, oldIf_packets_tx, if_packets_tx));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CollectdPackage.COLLECTD_INTERFACE__ALERTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AlertContainer.class) {
			switch (derivedFeatureID) {
				case CollectdPackage.COLLECTD_INTERFACE__ALERTS: return AlertsPackage.ALERT_CONTAINER__ALERTS;
				case CollectdPackage.COLLECTD_INTERFACE__ALERTING_TEMPLATE: return AlertsPackage.ALERT_CONTAINER__ALERTING_TEMPLATE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AlertContainer.class) {
			switch (baseFeatureID) {
				case AlertsPackage.ALERT_CONTAINER__ALERTS: return CollectdPackage.COLLECTD_INTERFACE__ALERTS;
				case AlertsPackage.ALERT_CONTAINER__ALERTING_TEMPLATE: return CollectdPackage.COLLECTD_INTERFACE__ALERTING_TEMPLATE;
				default: return -1;
			}
		}
