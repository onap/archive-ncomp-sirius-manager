...
public class MonitoringAdapterFactory extends AdapterFactoryImpl {
	...
	protected MonitoringSwitch<Adapter> modelSwitch =
		new MonitoringSwitch<Adapter>() {
			@Override
			public Adapter caseSiriusManagerAgentServer(SiriusManagerAgentServer object) {
				return createSiriusManagerAgentServerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.openecomp.ncomp.sirius.manager.agent.monitoring.SiriusManagerAgentServer <em>Sirius Manager Agent Server</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSiriusManagerAgentServerAdapter() {
		return null;
	}
