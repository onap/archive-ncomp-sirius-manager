 ...
 * @generated
 */
public class SwaggerContactImpl extends MinimalEObjectImpl.Container implements SwaggerContact {
	/**
	...
	protected EClass eStaticClass() {
		return SwaggerPackage.Literals.SWAGGER_CONTACT;
	}
	...
	public void setEmail(String newEmail) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SwaggerPackage.SWAGGER_CONTACT__EMAIL, oldEmail, email));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SwaggerPackage.SWAGGER_CONTACT__EMAIL:
				return getEmail();
		}
