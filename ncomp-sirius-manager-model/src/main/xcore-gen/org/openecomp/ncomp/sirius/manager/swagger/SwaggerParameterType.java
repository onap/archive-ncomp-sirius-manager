 ...
 * <!-- end-user-doc -->
 * @see org.openecomp.ncomp.sirius.manager.swagger.SwaggerPackage#getSwaggerParameterType()
 * @model
 * @generated
 */
public enum SwaggerParameterType implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int FORM_DATA_VALUE = 0;
	 ...
	 * @generated
	 */
	private static final SwaggerParameterType[] VALUES_ARRAY =
		new SwaggerParameterType[] {
			PATH,
			QUERY,
			HEADER,
			BODY,
	 ...
	 * @generated
	 */
	public static final List<SwaggerParameterType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static SwaggerParameterType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SwaggerParameterType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static SwaggerParameterType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SwaggerParameterType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static SwaggerParameterType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private SwaggerParameterType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
