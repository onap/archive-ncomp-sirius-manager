...
public class ControllermodelAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ControllermodelSwitch<Adapter> modelSwitch =
		new ControllermodelSwitch<Adapter>() {
			@Override
			public Adapter caseControllerModel(ControllerModel object) {
				return createControllerModelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.openecomp.ncomp.sirius.manager.controllermodel.ControllerModel <em>Controller Model</em>}'.
	 * <!-- begin-user-doc -->
