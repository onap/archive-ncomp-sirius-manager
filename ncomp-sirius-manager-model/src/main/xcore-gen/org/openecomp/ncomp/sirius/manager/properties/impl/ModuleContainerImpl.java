 ...
 * <ul>
 *   <li>{@link org.openecomp.ncomp.sirius.manager.properties.impl.ModuleContainerImpl#getModules <em>Modules</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ModuleContainerImpl extends MinimalEObjectImpl.Container implements ModuleContainer {
	...
	protected EClass eStaticClass() {
		return PropertiesPackage.Literals.MODULE_CONTAINER;
	}
	...
	public EList<Module> getModules() {
		if (modules == null) {
			modules = new EObjectContainmentEList<Module>(Module.class, this, PropertiesPackage.MODULE_CONTAINER__MODULES);
		}
		return modules;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PropertiesPackage.MODULE_CONTAINER__MODULES:
