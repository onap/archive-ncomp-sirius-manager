...
public class PropertiesFactoryImpl extends EFactoryImpl implements PropertiesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case PropertiesPackage.MODULE_PROPERTY: return createModuleProperty();
			case PropertiesPackage.MODULE: return createModule();
			default:
	...
	public ModuleProperty createModuleProperty() {
		ModulePropertyImpl moduleProperty = new ModulePropertyImpl();
